...
- 구독 잔량 표시 — 세 CLI(Claude·Codex·Antigravity)의 구독 잔량을 Sessions 헤더 아래 아이콘으로 표시한다. 아이콘은 5시간 창 잔량이고 주간 잔량과 리셋 시각은 툴팁에 있으며, 5분마다 갱신되고 Sessions 헤더의 새로고침 버튼으로 즉시 다시 읽는다.
