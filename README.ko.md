...
> 여러 AI 코딩 에이전트(Claude · Codex · Antigravity) 사이에서 작업 맥락이 자동으로 따라가는 도구. macOS 데스크탑 앱과 IDE 익스텐션 두 형태로 제공.
...
- IDE 익스텐션 — VS Code · Cursor · Antigravity IDE 등 VS Code 계열 IDE에서 동작. [설치·사용법](apps/extension/README.ko.md)
